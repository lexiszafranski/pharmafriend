  ...
  return (
    <>
      <header className="jumbotron text-center">
        <button className="button-54" onClick={handleLogin} style={{ position: 'absolute', top: 20, right: 80 }}>Login</button>
        <h1 style={{ textAlign: 'center', fontSize: '2rem', color: 'black', marginBottom: '10px', fontFamily: "'Work Sans', sans-serif" }}>F A Q S</h1>
        <p style={{ textAlign: 'center', fontSize: '1rem' }}>Need help? We got you covered!</p>
      </header>
      <section className="container">
        <div className="row align-items-start">
          <div className="col-md-12 text-left feature-box questions" style={{ backgroundColor: '#D1D8DE' }}>
      ...
      <footer className="text-center mt-4">
        <p style={{textAlign: 'center'}}>By Lexi, Napat, Wyatt, and Imran</p>
      </footer>
    </>
  );
};
